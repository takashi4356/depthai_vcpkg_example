...
def Pose():
    ...
    #    success, image = cap.read()
        ...
        if results.pose_landmarks:
            ...
            text = text + ("\"left_elbow_x\":"+str(int(results.pose_landmarks.landmark[15].x*image.shape[1]))+",\n")
            text = text + ("\"left_elbow_y\":"+str(int(results.pose_landmarks.landmark[15].y*image.shape[0]))+",\n")
            text = text + ("\"left_elbow_z\":"+ str(int(results.pose_landmarks.landmark[15].z*100))+ ",\n")
            text = text + ("\"left_elbow_visibility\":"+ str(int(results.pose_landmarks.landmark[15].visibility*100))+ ",\n")
            text = text + ("\"right_elbow_x\":"+str(int(results.pose_landmarks.landmark[16].x*image.shape[1]))+",\n")
            text = text + ("\"right_elbow_y\":"+str(int(results.pose_landmarks.landmark[16].y*image.shape[0]))+",\n")
            text = text + ("\"right_elbow_z\":"+ str(int(results.pose_landmarks.landmark[16].z*100))+ ",\n")
            text = text + ("\"right_elbow_visibility\":"+ str(int(results.pose_landmarks.landmark[16].visibility*100))+ "\n")
            text = text + ("}\n")
            f.writelines(text)
